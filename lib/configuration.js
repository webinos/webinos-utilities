    ...
    */
    ...
    this.createDefaultDirectories = function() {
        try {
            ...
            // In case of PZP this will be webinos but in case of Pzh it will be of form webinosPzh/user_emailid
    ...
    this.loadCertificates = function(cert) {
        ...
        var certList = [
            {folderName: null, fileName:"crl", object: ConfigContext.cert.crl},
    ...
    this.storeDetails = function(folderName, fileName, data) {
        ...
        try {
            if (typeof data === "object") {
                ...
                ConfigContext.emit("WRITE_ERROR", new Error("Object to store should be an object -"+ err));
            }
        } catch(err) {
