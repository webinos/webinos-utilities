...
(function () {
	...
	Discovery.prototype.removeRemoteServiceObjects = function(address) {
		...
		for (var i = 0; i < len; ){
			...
			var fallBack = services.serviceAddress;
			if (address) services.serviceAddress = services.serviceAddress && services.serviceAddress.split("/") && services.serviceAddress.split("/")[0];
			if(!address) services.serviceAddress = fallBack;
